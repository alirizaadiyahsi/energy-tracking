...
async def proxy_data(request: Request, path: str, current_user=Depends(get_current_user)):
...
async def proxy_analytics(request: Request, path: str, current_user=Depends(get_current_user)):
...
async def proxy_notifications(request: Request, path: str, current_user=Depends(get_current_user)):
