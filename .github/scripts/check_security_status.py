...
class SecurityStatusChecker:
    ...
    def check_all_reports(self) -> None:
        ...
        logger.info(f"Security check completed: {self.status['total_issues']} total issues found")
...
def main():
    """Main entry point."""
    parser = argparse.ArgumentParser(description='Check security status from scan results')
