...
class TestAuthFlow:
    ...
    async def test_user_login_flow(self):
        ...
        # Login data
        login_data = {"email": "integration@test.com", "password": "TestPass123!"}
    ...
    async def test_unauthorized_access(self):
        ...
        unauthorized_response.json.return_value = {"detail": "Not authenticated"}
    ...
    async def test_user_logout_flow(self):
        ...
        logout_response.json.return_value = {"message": "Successfully logged out"}
...
class TestRoleBasedAccess:
    ...
    async def test_user_forbidden_access(self):
        ...
        forbidden_response.json.return_value = {"detail": "Insufficient permissions"}
...
class TestAuthErrorHandling:
    ...
    async def test_invalid_credentials(self):
        ...
        error_response.json.return_value = {"detail": "Invalid email or password"}

        mock_client.post.return_value = error_response

        # Test login with invalid credentials
        invalid_login = {"email": "wrong@test.com", "password": "wrongpassword"}
    ...
    async def test_duplicate_registration(self):
        ...
        conflict_response.json.return_value = {"detail": "Email already exists"}
    ...
    async def test_malformed_token_handling(self):
        ...
        malformed_response.json.return_value = {"detail": "Invalid token format"}
...
class TestPasswordSecurity:
    ...
    async def test_password_change_flow(self):
        ...
        response = await mock_client.put(
            "/auth/change-password", json=password_change_data
        )
    ...
    async def test_password_reset_flow(self):
        ...
        reset_confirm = {"token": "reset.token.here", "newPassword": "NewPass789!"}
