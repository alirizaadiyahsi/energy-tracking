...
class TestRunner:
    ...
    def check_dependencies(self) -> bool:
        ...
        required_packages = [
            ...
            'factory-boy', 'faker', 'testcontainers'
        ]
        ...
        if missing_packages:
            ...
            self.print_colored("Run: pip install -r tests/test-requirements.txt", Colors.YELLOW)
            return False
    ...
    def run_integration_tests(self) -> bool:
        ...
        if not docker_available:
            self.print_colored("⚠️  Docker not available, skipping integration tests", Colors.YELLOW)
            return True
    ...
    def run_security_tests(self) -> bool:
        ...
        safety_success = self.run_command([
    ...
    def print_summary(self) -> None:
        ...
        self.print_colored(f"Tests passed: {passed}/{total}", 
...
Examples:
  ...
  python tests/run_tests.py --install-deps        # Install dependencies
    ...
    runner.print_colored("🚀 Energy Tracking System Test Runner", Colors.BLUE + Colors.BOLD)
    ...
    try:
        ...
        if args.all or (not any([args.unit, args.integration, args.performance, args.e2e, args.coverage, args.security])):
            # Run all test types
            test_functions = [
