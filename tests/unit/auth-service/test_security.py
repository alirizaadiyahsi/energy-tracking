...
class TestPermissionSystem:
    ...
    def test_resource_based_permissions(self):
        ...
        def check_resource_permission(user_permissions, resource, action, user_id=None, resource_owner_id=None):
        ...
        assert check_resource_permission(user_permissions, "devices", "write", user_id, user_id) is True
        assert check_resource_permission(user_permissions, "devices", "write", user_id, "other_user") is False
...
class TestSecurityHeaders:
    ...
    def test_security_headers(self):
        ...
        # Insecure headers
        insecure_headers = {
            "X-Frame-Options": "ALLOWALL"  # Missing other headers
        }
